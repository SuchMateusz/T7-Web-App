...
namespace WebAppMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230731182013_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.ContactDetail", b =>
                {
                    ...
                    b.Property<string>("ContactDetailInformaction")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Id")
                        .HasColumnType("int");

                    b.HasKey("ContactDetailTypeId", "CustomerId");
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.ContactDetailType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.ItemIngredients", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.ItemRecipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.Address", b =>
                {
                    b.HasOne("WebAppMVC.Domain.Model.Customer", "Customer")
                        ...
                        .HasForeignKey("WebAppMVC.Domain.Model.Address", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.ContactDetail", b =>
                {
                    b.HasOne("WebAppMVC.Domain.Model.ContactDetailType", "ContactDetailType")
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.ItemIngredients", b =>
                {
                    b.HasOne("WebAppMVC.Domain.Model.Item", "Item")
                        .WithOne("ItemIngredients")
                        .HasForeignKey("WebAppMVC.Domain.Model.ItemIngredients", "ItemRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebAppMVC.Domain.Model.ItemRecipe", b =>
                {
                    b.HasOne("WebAppMVC.Domain.Model.Item", "Item")
                        .WithOne("ItemRecipe")
                        .HasForeignKey("WebAppMVC.Domain.Model.ItemRecipe", "ItemRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
